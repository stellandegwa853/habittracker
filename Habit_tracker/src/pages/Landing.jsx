    ...
    >
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-5 sm:px-10 lg:px-14">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Link
            to="/register"
            className="inline-flex items-center justify-center rounded-full border border-stone-800/20 bg-stone-900/85 px-4 py-2 font-medium text-white shadow-sm transition hover:bg-stone-950 focus:outline-none focus:ring-2 focus:ring-stone-700/30"
          >
            Get Started
          </Link>
        </div>
      ...
      <section className="relative z-10 flex min-h-[calc(100vh-76px)] items-center justify-center px-6 pb-20 pt-12 text-center sm:px-10">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              to="/register"
              className="inline-flex w-full items-center justify-center rounded-full bg-stone-900/90 px-7 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-stone-950 focus:outline-none focus:ring-2 focus:ring-stone-700/30 sm:w-auto"
            >
              Get Started
            </Link>
            <Link
